...
buttons = document.getElementsByTagName('button'),
  result = document.getElementsByClassName('result-value')[0],
  resyltTable = document.getElementsByClassName('result-table')[0],
  ...
  optionalExpensesBtn = document.getElementsByTagName('button')[1], // вопросики
...
// if(a.length > 50){
//   alert("Напишите короче(Поле должно сдержать не более 50 символов)");
//   i--;
// }
// else if (a.length != 0 && (b.length == 0 || isNaN(b) || b == '' || b == null)){
